...
export default function Monaco() {
  ...
  const handleEditorDidMount = (editor, monaco) => {
    console.log("handleEditorDidMount mount");
  ...
  const handleCodeChange = (value, event) => {
    console.log("handleCodeChange event", event?.isFlush);
    console.log("handleCodeChange value", value);
    console.log("editorRef.getValue()", editorRef.current.getValue());
    if (event.isFlush !== undefined && !event.isFlush) {
      console.log("non flush update");
      dispatch({ type: UPDATE_CODE, payload: editorRef.current.getValue() });
    }
  };
